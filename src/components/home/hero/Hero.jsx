...
export const Hero = () => {
  return (
    <section className="min-h-screen w-full flex relative" id="home">
      ...
      <div className="absolute -translate-x-1/2 top-1/2 left-1/2 -translate-y-1/2 w-full sm:w-2/5 h-2/5 lg:h-1/2  intro-animation">
        <HeroCanvas />
        <div className="absolute inset-0 grid grid-cols-2   grid-rows-2 z-[-1]">
          ...
          <div className="absolute bottom-24 md:bottom-16 lg:bottom-8 left-1/2 w-1/2 h-32 border-4 border-[#7EB11B] bg-[#ECF8D3] [border-radius:72%_28%_75%_25%_/57%_24%_76%_43%]  transform -translate-x-1/2 translate-y-1/2 shadow-lg"></div>
        </div>
      </div>
